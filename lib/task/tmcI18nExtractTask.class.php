 ...
 */
class tmcI18nExtractTask extends sfBaseTask
{
  /**
   * @see sfTask
   */
  protected function configure()
  {
    ...
    $this->addOptions(array(
      new sfCommandOption('catalogue', null, sfCommandOption::PARAMETER_REQUIRED, 'The target catalogue', 'messages'),
...
If you want to specify the catalogue, use the [--catalogue=messages] option:
...
EOF;
  ...
  public function execute($arguments = array(), $options = array())
  {
    ...
    if ($options['auto-save'])
    {
      ...
      $this->logSection('i18n', sprintf('saved "%d" message(s)',  $class->getMessageSource()->getNumSaved()));
    }
